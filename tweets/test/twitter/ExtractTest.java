...
public class ExtractTest {
    ...
    private static final Tweet tweet1 = new Tweet(1, "essa", "is it reasonable to talk about rivest so much? alyssa@gmail.com", d1);
    private static final Tweet tweet2 = new Tweet(2, "bbitdiddle", "@rivest talk in 30 minutes #hype, @dave's attending? ", d2);
    private static final Tweet tweet3 = new Tweet(3, "zeshan", "@waqas are your Kidding? ", d3);
    private static final Tweet tweet4 = new Tweet(4, "talal", "@zeshan Lets have some fun:) ", d4);
